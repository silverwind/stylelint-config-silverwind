const index = {
  ...
  ignoreFiles: [
    // TODO: these do not work from the shared config, likely a Stylelint bug
    "**/dist/**",
    "**/build/**",
    "**/node_modules/**"
  ],
  rules: {
    ...
    // TODO": ["modern", {ignore: "with-var-inside"}]
    ...
    // disabled until multi-file linting works
    ...
    // https://github.com/stylelint/stylelint/issues/8698
